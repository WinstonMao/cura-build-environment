if(NOT BUILD_OS_WINDOWS)
    ...
    if( BUILD_OS_WIN32 )
        add_custom_target(NumPy
            COMMAND ${PYTHON_EXECUTABLE} -m pip install http://software.ultimaker.com/cura-binary-dependencies/numpy-1.14.2+mkl-cp36-cp36m-win32.whl
            COMMENT "Installing NumPy"
        )
    else()
        add_custom_target(NumPy
            COMMAND ${PYTHON_EXECUTABLE} -m pip install http://software.ultimaker.com/cura-binary-dependencies/numpy-1.14.2+mkl-cp36-cp36m-win_amd64.whl
            COMMENT "Installing NumPy"
        )
    endif()
endif()
